...
<p align="center">
  <a href="https://streamvibe12.vercel.app">🌐 Live Demo</a> •
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Frontend-Vercel-black?logo=vercel&style=plastic" />
  <img src="https://img.shields.io/badge/Backend-Render-46a2f1?logo=render&style=plastic" />
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/TheHarshitBansal/AI-Movie-Recommendation-System/main/client/src/assets/coverImage.png" alt="Project Preview" width="100%" />
</p>
...
- 🧠 **AI-Powered Search** — Ask movie or show related questions using **AI** for smart, conversational suggestions  
...
- 🌐 **Deployed UI on Vercel** — Fast, globally distributed UI powered by Vercel’s edge network
...
- 🛰️ **API Hosting on Render** — Backend and authentication APIs are deployed on **Render** for high availability and scalability  
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Render-46a2f1?logo=render&style=for-the-badge" />
  
</p>

| Tech/Tool        | Purpose & Benefits |
|------------------|--------------------|
| ⚛️ React         | Frontend UI with component-based architecture |
| ⚡ Vite           | Lightning-fast frontend dev server and build tool |
| 🧾 Redux         | Global state management across components |
| 🎨 TailwindCSS   | Utility-first CSS for responsive design |
| 🎨 Figma         | UI/UX design prototyping |
| 🔐 JWT           | JSON Web Token-based authentication |
| 💳 Razorpay      | Seamless payment gateway for subscriptions |
| 🧠 Google Gemini | Conversational AI-powered movie search |
| 📦 Express.js    | Backend web framework and REST API server |
| 🌿 MongoDB       | Document database for storing users and movies |
| 🚀 Vercel        | Deployment platform for frontend (CI/CD) |
| 🛰️ Render        | Backend and API hosting with autoscaling |
...
Just fork this repo, create a feature branch, and open a pull request.

Let’s revolutionize how we explore and enjoy movies and shows! 🎥
